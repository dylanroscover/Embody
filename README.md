...
![Version](https://img.shields.io/badge/version-6.0.54-blue)
...
Embody includes **74 test suites** (1,725 tests) covering core externalization, MCP tools, TDN format, the Envoy server/bridge, and palette catalogs. Tests run inside TouchDesigner using a custom test runner with sandbox isolation.
