...
[![Version](https://img.shields.io/badge/version-6.2.59-6ee668?style=flat-square&labelColor=181e1e)](https://github.com/dylanroscover/Embody/releases/latest)
...
- **6.2.59** — a fresh clone keeps the Envoy it adopts; a rollback no longer claims the version it discarded; the release gate's identity check stopped failing healthy builds and passing on runtime tables
- **6.2.57** — TDXN exports operator references as authored and rebases in-project absolute paths (fixes #132); a fresh clone adopts the committed Envoy declaration; one-command fresh-install release smoke, with the macOS leg in CI
