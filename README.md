...
[![MCP Tools](https://img.shields.io/badge/MCP_tools-56-6ee668?style=flat-square&labelColor=181e1e)](https://modelcontextprotocol.io/)
...
| | What | Why it matters |
|---|---|---|
| 🤖 | **Envoy MCP Server** | 56 tools let your AI assistant build, wire, parameterize, and debug live networks. The first time you watch it happen, you stop typing operator names by hand for good. |
