...
[![Version](https://img.shields.io/badge/version-6.0.206-6ee668?style=flat-square&labelColor=181e1e)](https://github.com/dylanroscover/Embody/releases/latest)
...
- **6.0.207**: **Convoy node names stop baking the unsaved placeholder** -- the Node Name fill ran at extension load, before the wizard's save step, so fresh installs registered as `hostname / NewProject.1` no matter what the project was saved as; the fill now waits for a saved project and heals an already-baked placeholder in place, with five contract tests pinning the ordering.
