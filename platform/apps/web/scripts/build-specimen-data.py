...
def build_graph(parsed: dict) -> dict:
    """Reduce a full parsed TDXN dict to the minimal TdnViewer input shape."""
    graph: dict = {}
...
def main() -> int:
    ...
    for spec in specimens:
        ...
        raw_bytes = tdn_path.read_bytes().replace(b"\r\n", b"\n")
...
def write_graphs_ts(rows: list[dict], graphs: dict) -> None:
    header = (
        ...
        "//\n"
        "// Each entry is the parsed TDXN network trimmed to what TdnViewer renders\n"
