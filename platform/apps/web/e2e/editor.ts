...
// The contribute/edit TDXN field is a CodeMirror 6 editor (TdxnYamlEditor) backed
...
export async function fillTdxn(page: Page, value: string): Promise<void> {
  const content = page.locator(".tdxn-editor__cm .cm-content");
  await content.click();
