...
class TestMCPPerformance(EmbodyTestCase):
    ...
    def test_basic_return_structure(self):
        ...
        result = self.embody.ext.Envoy._get_op_performance(op_path=comp.path)
    ...
    def test_include_children(self):
        ...
        result = self.embody.ext.Envoy._get_op_performance(
    ...
    def test_nonexistent_op(self):
        ...
        result = self.embody.ext.Envoy._get_op_performance(op_path='/nonexistent/op')
