...
class TestMCPOperators(EmbodyTestCase):
    ...
    def test_create_op_valid(self):
        result = self.embody.ext.Envoy._create_op(
    ...
    def test_delete_op_existing(self):
        ...
        result = self.embody.ext.Envoy._delete_op(op_path=comp.path)
        self.assertTrue(result.get('success'))

    def test_delete_op_nonexistent(self):
        result = self.embody.ext.Envoy._delete_op(op_path='/nonexistent/op')
        self.assertDictHasKey(result, 'error')
    ...
    def test_get_op_returns_info(self):
        ...
        result = self.embody.ext.Envoy._get_op(op_path=comp.path)
    ...
    def test_get_op_nonexistent(self):
        result = self.embody.ext.Envoy._get_op(op_path='/nonexistent')
        self.assertDictHasKey(result, 'error')
    ...
    def test_copy_op_basic(self):
        ...
        result = self.embody.ext.Envoy._copy_op(
    ...
    def test_rename_op(self):
        ...
        result = self.embody.ext.Envoy._rename_op(
    ...
    def test_query_network_basic(self):
        ...
        result = self.embody.ext.Envoy._query_network(parent_path=self.sandbox.path)
    ...
    def test_query_network_with_type_filter(self):
        ...
        result = self.embody.ext.Envoy._query_network(
    ...
    def test_query_network_nonexistent(self):
        result = self.embody.ext.Envoy._query_network(parent_path='/nonexistent')
        self.assertDictHasKey(result, 'error')
    ...
    def test_find_children_by_name(self):
        ...
        result = self.embody.ext.Envoy._find_children(
    ...
    def test_cook_op(self):
        ...
        result = self.embody.ext.Envoy._cook_op(op_path=comp.path)
        self.assertTrue(result.get('success'))

    def test_cook_op_nonexistent(self):
        result = self.embody.ext.Envoy._cook_op(op_path='/nonexistent')
        self.assertDictHasKey(result, 'error')
