"""Pure-engine tests for TDXNExt's semantic diff (_diff_normalized / _normalize_
...
class TestTDNDiffEngine(EmbodyTestCase):
    ...
    def test_compression_equivalence_is_empty(self):
        ...
        compressed = {'type': 'baseCOMP', 'operators': [
            ...
            'type_defaults': {'noiseTOP': {'parameters': {'period': 2}}}}
        d = op.Embody.ext.TDXN._diff_normalized(inline, compressed, comp_path='/p')
    ...
    def test_operator_reorder_is_clean(self):
        ...
        b = {'operators': [{'name': 'n2', 'type': 'noiseTOP'},
                           {'name': 'n1', 'type': 'noiseTOP'}]}
        self.assertFalse(
            op.Embody.ext.TDXN._diff_normalized(a, b, comp_path='/p')['changed'])
    ...
    def test_root_pseudo_op_param_change(self):
        ...
        d = op.Embody.ext.TDXN._diff_normalized(a, b, comp_path='/scene')
    ...
    def test_added_and_removed_ops(self):
        ...
        b = {'operators': [{'name': 'a', 'type': 'noiseTOP'},
                           {'name': 'c', 'type': 'blurTOP'}]}
        d = op.Embody.ext.TDXN._diff_normalized(a, b, comp_path='/p')
    ...
    def test_deep_child_change_does_not_mark_ancestors(self):
        ...
        d = op.Embody.ext.TDXN._diff_normalized(net(2), net(1), comp_path='/p')
    ...
    def test_truncation_is_honest(self):
        ...
        d = op.Embody.ext.TDXN._diff_normalized(
    ...
    def test_identical_is_clean(self):
        ...
        self.assertFalse(op.Embody.ext.TDXN._diff_normalized(
    ...
    def test_baseline_and_schema(self):
        ...
        self.assertEqual(d['schema_version'],
                         op.Embody.ext.TDXN._DIFF_SCHEMA_VERSION)
...
class TestTDNDiffDatContent(EmbodyTestCase):
    ...
    def test_v15_array_vs_v2_string_normalizes_equal(self):
        ...
        live = {'operators': [{'name': 'd', 'type': 'textDAT',
                               'dat_content_format': 'text',
    ...
    def test_v15_unchanged_dat_does_not_diff(self):
        ...
        live = {'operators': [{'name': 'd', 'type': 'textDAT',
                               'dat_content_format': 'text',
                               'dat_content': 'a\nb\nc'}]}
        env = op.Embody.ext.TDXN._diff_normalized(live, disk)
        self.assertFalse(env['changed'],
                         'v1.5/v2.0 dat_content reformat must not diff: %s'
                         % env.get('counts'))
