...
class TestMCPDiagnostics(EmbodyTestCase):
    ...
    def test_get_td_info(self):
        result = self.embody.ext.Envoy._get_td_info()
    ...
    def test_get_op_errors_clean_op(self):
        ...
        result = self.embody.ext.Envoy._get_op_errors(
    ...
    def test_exec_op_method_cook(self):
        ...
        result = self.embody.ext.Envoy._exec_op_method(
    ...
    def test_get_td_classes(self):
        result = self.embody.ext.Envoy._get_td_classes()
    ...
    def test_get_td_class_details_op(self):
        result = self.embody.ext.Envoy._get_td_class_details(class_name='OP')
        self.assertDictHasKey(result, 'methods')

    def test_get_td_class_details_nonexistent(self):
        result = self.embody.ext.Envoy._get_td_class_details(
    ...
    def test_get_module_help_td_attr(self):
        ...
        result = self.embody.ext.Envoy._get_module_help(module_name='OP')
        self.assertDictHasKey(result, 'helpText')
        self.assertIn('OP', result['helpText'])

    def test_get_module_help_tdu(self):
        result = self.embody.ext.Envoy._get_module_help(module_name='td.tdu')
        self.assertDictHasKey(result, 'helpText')
    ...
    def test_get_logs_returns_entries(self):
        ...
        result = self.embody.ext.Envoy._get_logs()
    ...
    def test_get_logs_count_capped(self):
        result = self.embody.ext.Envoy._get_logs(count=5)
