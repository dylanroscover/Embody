---
description: "Thread boundary, localhost binding, timeout, and Envoy's own host (never destroy or reload the Embody COMP from a call) rules for the Envoy MCP server"
---
