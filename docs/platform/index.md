...
[**embody.tools**](https://embody.tools) is the public home for **Specimens**: transparent TouchDesigner networks you can inspect, copy, and drop straight into your own project. Where a typical "download this `.tox`" is an opaque binary, every Specimen is a **TDXN** network — human-readable YAML you can read before you run, and paste into any TouchDesigner `.toe` running [Embody](https://github.com/dylanroscover/Embody).

The site is built on Astro + Cloudflare Workers and is **fully browsable without an account**.

## What's here

- **[The Collection](collection.md)** — browse Specimens, inspect their node graph in the browser, and copy a Specimen's TDXN to your clipboard ("embody it").
...
1. On a Specimen, hit **embody it** — its TDXN is copied to your clipboard.
