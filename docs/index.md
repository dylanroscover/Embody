...
-   :material-robot:{ .lg .middle } **Envoy** — Forward Velocity
    ...
    An embedded [MCP](https://modelcontextprotocol.io/) server with **48 tools** that lets Claude Code, Cursor, and Windsurf talk directly to your live TouchDesigner session. Say what you want — operators, connections, parameters, extensions, fixes — and watch it happen. Idea → network in seconds.
