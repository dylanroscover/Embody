...
- **Meta-tools**: `get_td_status`, `launch_td`, `restart_td`, `switch_instance`, and the 15 `convoy_*` tools run entirely on the bridge — no Envoy connection required (Convoy tools talk to the local host app instead)
